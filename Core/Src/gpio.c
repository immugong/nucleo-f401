...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, PS2_CS_Pin|I2C_RST_R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PS2_CS_Pin I2C_RST_R_Pin */
  GPIO_InitStruct.Pin = PS2_CS_Pin|I2C_RST_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
